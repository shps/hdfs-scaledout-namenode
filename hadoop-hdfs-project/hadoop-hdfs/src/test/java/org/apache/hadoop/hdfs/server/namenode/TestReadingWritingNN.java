...
public class TestReadingWritingNN extends TestCase {
    ...
    public void testWritingAndReading() throws Exception {
        ...
        MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf).numNameNodes(2).numDataNodes(2).build();
        try {
                    FsUrlStreamHandlerFactory factory =
                new org.apache.hadoop.fs.FsUrlStreamHandlerFactory();
        java.net.URL.setURLStreamHandlerFactory(factory);

            FileSystem wfs = cluster.getFileSystem();
            ...
            FileSystem rfs1 = cluster.getFileSystem(0);
            URI uri = rfs1.getUri();
            ...
            FileSystem rfs2 = cluster.getFileSystem(0);
