...
public class TestSafeMode {
     ...
     * not come out of safe mode even after the startup safe mode conditions are
     * met. <ol> <li>Start cluster with 1 data-node.</li> <li>Create 2 files
     * with replication 1.</li> <li>Re-start cluster with 0 data-nodes.
     * Name-node should stay in automatic safe-mode.</li> <li>Enter safe mode
     * manually.</li> <li>Start the data-node.</li> <li>Wait longer than
     * <tt>dfs.namenode.safemode.extension</tt> and verify that the name-node is
     * still in safe mode.</li> </ol>
     *
     * @throws IOException
     */
    /*
    ...
    */
    ...
    /**
     * Run various fs operations while the NN is in safe mode, assert that they
     * are either allowed or fail as expected.
     */
    @Test
