...
public class TestRenameWhileOpen extends junit.framework.TestCase
{
  ...
  public static final int NUM_NAMENODES = 2;
        {
        ...
        public void testWhileOpenRenameParent() throws IOException
        {
                ...
                // create cluster
                MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf).numNameNodes(NUM_NAMENODES).build();
                ...
                try
                {
                        ...
                        cluster = new MiniDFSCluster.Builder(conf).nameNodePort(nnport).format(false).numNameNodes(NUM_NAMENODES).build();
                        cluster.waitActive();
