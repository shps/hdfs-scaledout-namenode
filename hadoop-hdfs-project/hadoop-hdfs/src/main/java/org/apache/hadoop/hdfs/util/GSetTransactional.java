...
/**
 * A {@link GSetTransactional} is set extended from {@link GSet},
...
public interface GSetTransactional<K, E extends K> extends GSet<K, E> {
  /**
   ...
   * @param isTransactional  The value to decide whether this operation is part of an atomic transaction
