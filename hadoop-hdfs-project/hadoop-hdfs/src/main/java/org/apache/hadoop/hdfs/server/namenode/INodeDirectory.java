...
public class INodeDirectory extends INode {
  ...
  private INode getChildINode(byte[] name) {
    if (children == null) {
      return EntityManager.getInstance().find(INodeFinder.ByNameAndParentId,
  ...
  public <T extends INode> T addChild(final T node, boolean inheritPermission,
    ...
    if (children != null) {
      ...
      INode inode = EntityManager.getInstance().find(INodeFinder.ByNameAndParentId,
              node.getName(), getId());
      if (inode != null) {
        return null;
      }
  ...
  public List<INode> getChildren() {
    if (children == null) {
      children = (List<INode>) 
              EntityManager.getInstance().findList(INodeFinder.ByParentId, getId());
    }
    return children;
  }
