...
#attribute?('cloud') ? cloud['local_ipv4'] : ipaddress
...
when "centos", "redhat", "fedora", "suse", "scientific", "amazon"
  ...
  set['mysql']['kthfs_path']                 = "/etc/mysql_kthfs.sql"
...
when "freebsd"
  ...
  set['mysql']['kthfs_path']                 = "/var/db/mysql/mysql_kthfs.sql"
when "windows"
...
when "mac_os_x"
  ...
  set['mysql']['kthfs_path']                 = "/etc/mysql/kthfs.sql"
