...
do
	...
	ssh $connectStr 'chmod +x '$remoteReleaseDir'/conf/*.sh'
	...
	ssh $connectStr 'cp '$remoteReleaseDir'/conf/set-env.sh '$remoteReleaseDir'/'
	ssh $connectStr 'cp '$remoteReleaseDir'/conf/startNN.sh '$remoteReleaseDir'/'
	ssh $connectStr 'cp '$remoteReleaseDir'/conf/startDN.sh '$remoteReleaseDir'/'
	ssh $connectStr 'cp '$remoteReleaseDir'/conf/startClient.sh '$remoteReleaseDir'/'
