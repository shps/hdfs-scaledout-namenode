...
$HADOOP org.apache.hadoop.fs.loadGenerator.StructureGenerator -maxDepth 1 -minWidth 1 -maxWidth 5 -numOfFiles 10 -outDir /tmp/$NN/  
...
$HADOOP org.apache.hadoop.fs.loadGenerator.LoadGenerator -numOfThreads 100 -elapsedTime 5 -startTime 1 -root /$NN -readProbability 0.0 -writeProbability 0.0
