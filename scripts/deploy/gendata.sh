...
#echo "LOAD DATA INFILE '".$f1."' IGNORE INTO TABLE INodeTableSimple FIELDS TERMINATED BY ','  LINES TERMINATED BY '##\\n' (@var4) SET isDir= CAST(@var4 AS UNSIGNED), (@var11) SET isUnderConstruction= CAST(@var11 AS UNSIGNED), (@var15) SET isClosedFile= CAST(@var15 AS UNSIGNED), (@var17) SET isDirWithQuota= CAST(@var17 AS UNSIGNED);\n";
echo "LOAD DATA INFILE '".$f1."' IGNORE INTO TABLE INodeTableSimple FIELDS TERMINATED BY ','  LINES TERMINATED BY '##\\n';\n";
echo "LOAD DATA INFILE '".$f2."' IGNORE INTO TABLE BlockInfo FIELDS TERMINATED BY ','  LINES TERMINATED BY '##\\n';\n";
echo "LOAD DATA INFILE '".$f3."'IGNORE INTO TABLE triplets FIELDS TERMINATED BY ','  LINES TERMINATED BY '##\\n';\n";
